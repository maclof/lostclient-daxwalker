...
//                        nonDisplayableMapImageGraphics.drawRect(localX, localY, TILE_WIDTH, TILE_WIDTH);
        ...
        affineTransform.rotate(Math.toRadians(Camera.getCameraYaw()), mapCenter.x - (REGION_SIZE/2 * TILE_WIDTH) + (REGION_SIZE/2 * TILE_WIDTH) + TILE_WIDTH/2, mapCenter.y -(REGION_SIZE/2 * TILE_WIDTH) + (REGION_SIZE/2 * TILE_WIDTH) + TILE_WIDTH/2);

...
public class RunePouch{
    ...
    public enum RuneSlot {
        ...
        public String getRuneName(){
            switch(PlayerSettings.getBitValue(type)){
        ...
        public int getQuantity(){
            return PlayerSettings.getBitValue(quantityVarbitIndex);
        }
    ...
    private static boolean hasPouch(){
        return Inventory.count("Rune pouch") > 0 && Worlds.getMyWorld().isMember();
    }
